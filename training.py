...
PARENT_DATA_DIR = '/home/alpias/Extra/Downloads/Custom_Face_Recognition_System/Dataset'
...
def build_model(input_shape=(IMG_SIZE, IMG_SIZE, 3), num_classes=number_of_classes):
    enet = efn.EfficientNetB4(input_shape=input_shape, weights='imagenet', include_top=False)
